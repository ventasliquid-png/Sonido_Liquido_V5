from sqlalchemy import Column, Integer, String, Boolean, DateTime, ForeignKey, Text, Numeric, BigInteger
...
class ProductoCosto(Base):
    ...
    margen_sugerido = Column(Numeric(6, 2), nullable=False, default=0) # Campo para análisis Carlos
