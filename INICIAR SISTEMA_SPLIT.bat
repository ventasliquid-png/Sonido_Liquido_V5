...
start "GY BACKEND (Uvicorn)" cmd /k "IF EXIST backend\venv\Scripts\activate.bat (call backend\venv\Scripts\activate.bat) & python -m uvicorn backend.main:app --host 0.0.0.0 --port 8080 --reload"
