// [IDENTIDAD] - frontend\src\views\Agenda\ContactosView.vue
// Versión: V5.6 GOLD | Sincronización: 20260407130827
// ------------------------------------------

<template>
  <div class="flex h-screen w-screen bg-[#0a0a0a] overflow-hidden">
    <!-- Global Sidebar (Integrated for Standalone View) -->
    <AppSidebar theme="amber" />
    ...
    <main class="flex-1 relative overflow-hidden flex flex-col">
       ...
       <div class="flex-1 relative overflow-hidden flex flex-col bg-[var(--hawe-bg-main)] text-gray-200 font-sans">
...
import ContactCanvas from './components/ContactCanvas.vue'
...
const hydrateData = async () => {
    try {
        if (contactosStore.contactos.length === 0) {
            console.log("[Agenda] Hydrating contacts...")
            await contactosStore.fetchContactos()
        }
    } catch (e) {
        console.error("[Agenda] Error hydrating:", e)
    }
}
