      ...
      <div class="flex-1 overflow-y-auto p-6 scrollbar-thin scrollbar-track-gray-900 scrollbar-thumb-gray-700">
        ...
        <div v-else-if="viewMode === 'grid'" class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          <div 
            ...
            class="group relative flex flex-col justify-between rounded-xl border border-white/5 bg-white/5 p-4 transition-all hover:bg-white/10 hover:shadow-xl hover:shadow-orange-900/20 cursor-pointer"
            :class="{ 'ring-2 ring-orange-500 bg-white/10': selectedId === transporte.id }"
          >
            <div class="flex items-start justify-between">
                <div class="flex items-center gap-3 overflow-hidden">
                    ...
                    <div class="min-w-0">
                        <h3 class="font-bold text-white leading-tight group-hover:text-orange-300 transition-colors truncate">{{ transporte.nombre }}</h3>
