...
> [!IMPORTANT]
> **CONTROL DEL OPERADOR**: El sistema NO debe ejecutar el cierre de forma autónoma. El OPERADOR (usuario) debe dar la orden explícita de "INICIAR PROTOCOLO DE CIERRE" o "OMEGA". El sistema debe permanecer a la espera de instrucciones hasta que esta orden sea recibida.
