...
print("Attempting to fetch AFIP data...")
try:
    cuit_galan = "27311111111" # Dummy CUIT for physical person
    res = requests.get(f"http://127.0.0.1:8011/clientes/afip/{cuit_galan}", timeout=15)
    print("AFIP response:", res.status_code, res.text)
